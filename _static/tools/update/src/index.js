...
function taskPingDo(dev)
{
  ...
  dev.sendReport(0, new Uint8Array(bootloader_cmd_ping));
}

function taskResetDo(dev)
{
  const bootloader_cmd_reset = [0x00, 0x00, 0x02, 0x00, 0x00, 0x00];
  dev.sendReport(0, new Uint8Array(bootloader_cmd_reset));
}
...
function taskGetHwVersionDo(dev)
{
  ...
  dev.sendReport(0, new Uint8Array(bootloader_cmd_get_hw_version));
}
...
function taskGetSwVersionDo(dev)
{
  ...
  dev.sendReport(0, new Uint8Array(bootloader_cmd_get_sw_version));
}
